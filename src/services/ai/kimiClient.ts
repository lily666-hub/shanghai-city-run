...
export class KimiClient {
  ...
  async sendMessage(request: AIRequest): Promise<AIResponse> {
    ...
    try {
      ...
      console.group('🚀 KIMI API 请求详情');
      console.log('📍 请求URL:', `${this.baseUrl}/chat/completions`);
      console.log('🔧 请求方法:', 'POST');
      console.log('📝 模型:', this.model);
      console.log('💬 用户消息:', userMessage);
      console.log('🎯 对话类型:', request.conversationType || 'general');
      ...
      console.log('💡 AI回复内容:', data.choices[0]?.message?.content || '无内容');
      console.log('📈 使用统计:', {
